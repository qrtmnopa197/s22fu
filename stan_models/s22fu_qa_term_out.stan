// Same as model_pred_arl_nonuis.stan, except this outputs the the term (bq(Q_a-Q_b) + bq(A_a-A_b)) for each trial
...
transformed parameters {
  ...
  vector[n_s*n_t] q_a_term; // (bq(Q_a-Q_b) + ba(A_a-A_b))
  ...
  {//anonymous_scope_start
    ...
    for (s in 1:n_s) {
      for (t in 1:n_t){
        ...
        q_a_term[(s-1)*n_t+t] = beta[s]*(Q[s,t,fA[s,t]] - Q[s,t,fB[s,t]]) + aff_sens[s]*(A[s,t,fA[s,t]] - A[s,t,fB[s,t]]);
