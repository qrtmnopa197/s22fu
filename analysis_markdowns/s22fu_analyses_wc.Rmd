...
s2_vrec$zero_recovery_summary$by_prediction
s2_vrec$zero_recovery_summary$by_condition
s2_vrec$zero_recovery_summary$overall

# For each true-zero vector, check whether the recovered median is exactly zero.
s2_vrec$zero_median_summary
...
# Recreate median-at-zero checks for vectors with true target length 0.
