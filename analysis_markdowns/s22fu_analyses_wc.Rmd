...
write.csv(s2_vrec$estimates,paste0(rec_dir,"s2_vector_recovery_estimates.csv"),row.names=FALSE)

ggsave(paste0(fig_dir,"s2_vector_recovery_panel.pdf"),s2_vrec$panel_plot,width=5.5,height=3.8,device=cairo_pdf,bg="white")
ggsave(paste0(fig_dir,"s2_vector_recovery_reward.pdf"),s2_vrec$condition_plots[["reward"]],width=2.4,height=1.8,device=cairo_pdf,bg="white")
ggsave(paste0(fig_dir,"s2_vector_recovery_pe.pdf"),s2_vrec$condition_plots[["pe"]],width=2.4,height=1.8,device=cairo_pdf,bg="white")
ggsave(paste0(fig_dir,"s2_vector_recovery_cc.pdf"),s2_vrec$condition_plots[["cc"]],width=2.4,height=1.8,device=cairo_pdf,bg="white")
ggsave(paste0(fig_dir,"s2_vector_recovery_blend.pdf"),s2_vrec$condition_plots[["blend"]],width=2.4,height=1.8,device=cairo_pdf,bg="white")
```
...
```{r}
s2_vrec_replot <- build_vector_recovery_plots_from_file(
  estimates_file = paste0(rec_dir,"s2_vector_recovery_estimates.csv"),
  hide_axis_text = TRUE
)

s2_vrec_replot$panel_plot
```
