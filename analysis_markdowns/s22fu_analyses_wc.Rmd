...
s2_vrec$zero_off_summary$by_prediction
s2_vrec$zero_off_summary$by_condition
s2_vrec$zero_off_summary$overall
...
zero_off_replot <- summarize_zero_recovery(
  length_df = read.csv(paste0(rec_dir, "s2_vector_recovery_",rec_tag,"_estimates.csv"), stringsAsFactors = FALSE),
  include_resid = FALSE
)

zero_off_replot$by_prediction
zero_off_replot$by_condition
zero_off_replot$overall
```
